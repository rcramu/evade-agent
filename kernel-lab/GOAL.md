...
|---|---|---|
| Seven-cell pipeline (L1, M1, A2, A4, A6, A8, A9) → C5 | **Achieved** | pytest + `kernel_pilot.json` |
| All seven Section 8 agents, seven cells | **Achieved** | `kernel_pilot_agents.json`; file-only MCP (no cluster) |
...
| Full `products_executed: true` | **Achieved (lab cells)** | Falco M1/A2/A4/A8/A9 + Tetragon L1/A6/A2/A4/A8/A9; A9 ticks inverted in the join |
...
| Field SLO | **Not achieved** | `field_executed: false` until `EVADE_FIELD_LOG` points at a production export |

The JSS manuscript stays on `evadeagent-eval-v3`. Do not copy kernel-lab cells into Section 8.

On this host the achievable goal is done: **Phase 1 products (including A2/A4/A8/A9) + Phase 2 TLS MCP and observer**. Phase 3 field SLO needs a production `EVADE_FIELD_LOG`.
